...
| type              | Description                                                                                           |
| ----------------- | ----------------------------------------------------------------------------------------------------- |
| `default`         | default style should not be used in app                                                               |
...
- 🎨 [Figma](https://www.figma.com/file/aWgwMrzdAuv9VuPdtst64uuw/MetaMask---Design-System?node-id=281%3A622)
- ✏️ [Documentation](https://www.notion.so/Buttons-bff3c30b33d74ffeabbc19b5e7b6b681)
